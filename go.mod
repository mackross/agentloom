module github.com/mackross/agentloom
...
require (
	...
	github.com/tphakala/go-audio-resampler v1.3.0 // indirect
...
replace github.com/openai/openai-go/v3 => github.com/mackross/openai-go/v3 v3.33.1-0.20260502151956-b6b6d1dae839
