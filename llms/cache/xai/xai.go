// Package xai adds metadata that changes xAI Responses request params.
// Queue metadata after any request item; the streamer uses the last non-cleared
// value to set prompt_cache_key on the API request.
package xai

import "github.com/mackross/agentloom/threads"

const (
	PromptCacheKeyKey       = "cache/xai/prompt_cache_key"
	PromptCacheRetentionKey = "cache/xai/prompt_cache_retention"

	RetentionInMemory = "in-memory"
	Retention24h      = "24h"
)

// PromptCacheKey sets prompt_cache_key, improving routing/cache locality on xAI.
...
// PromptCacheRetention sets prompt_cache_retention when supported.
